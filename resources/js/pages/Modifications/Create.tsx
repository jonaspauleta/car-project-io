...
export default function ModificationCreate({ car }: ModificationCreateProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head
                title={`Add Modification - ${car.nickname || `${car.make} ${car.model}`}`}
            />
                ...
                <div className="max-w-2xl">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Enter the details for your new modification
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Form
                                action={cars.modifications.store.url(car)}
                                method="post"
                                className="space-y-6"
                            >
                                {({ processing, errors }) => (
                                    <>
                                        ...
                                        <div className="flex gap-4 pt-4">
                                            ...
                                            <Link
                                                href={cars.modifications.index.url(
                                                    { car },
                                                )}
                                            >
                                                <Button

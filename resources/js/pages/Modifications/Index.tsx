...
export default function ModificationsIndex({ car, modifications, filters }: ModificationsIndexProps) {
    ...
    const handleSearch = (e: React.FormEvent) => {
        ...
        if (isActive && isActive !== 'all') params['filter[is_active]'] = isActive;
                                    ...
                                    <Select value={name} onValueChange={setName}>
                                        ...
                                        <SelectContent>
                                            ...
                                            {uniqueNames.map((nameOption) => (
                                                <SelectItem key={nameOption} value={nameOption}>
                                                    {nameOption}
                                                </SelectItem>
                                            ))}
                                        </SelectContent>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={vendor} onValueChange={setVendor}>
                                        ...
                                        <SelectContent>
                                            ...
                                            {uniqueVendors.map((vendorOption) => (
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between">
                                            ...
                                            <div className="flex items-center gap-6 text-sm text-muted-foreground">
                                                {modification.installation_date && (
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        Installed {formatDate(modification.installation_date)}
                                                    </div>
                                                )}
                                                {modification.cost && (
                                                    <div className="flex items-center gap-1">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    <Calendar className="h-4 w-4" />
                                                    Added {formatDate(modification.created_at)}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <Link href={cars.modifications.edit.url({ car: car.id, modification: modification.id })}>
                                                <Button variant="ghost" size="sm">
                                                    Edit
                                                </Button>
                                            </Link>
